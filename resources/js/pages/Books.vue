<template>
  <MainLayout>
    <div class="container mx-auto px-4 py-8">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody>
                                    <tr v-if="books.length === 0">
                                        <td colspan="7" class="text-center py-8 text-gray-400">No books found.</td>
                                    </tr>
        ...
        <!-- Create/Edit Modal -->
        <div v-if="showCreateModal && (hasPermission('create_books') || hasPermission('edit_books'))" class="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center">
            <div class="bg-white rounded-lg p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <form @submit.prevent="handleSubmit" class="space-y-6">
                    ...
                    <!-- File Upload -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Book File</label>
...
const editBook = (book) => {
    ...
    form.value = {
        ...
        authors: book.authors.map(author => author.uuid),
        categories: book.categories.map(category => category.uuid),
        file: null,
...
const forceDeleteBook = async (book) => {
    ...
    try {
        ...
        toast.error('Failed to permanently delete book.');
    }
};

const viewBook = (book) => {
    router.push({ name: 'BookDetails', params: { uuid: book.uuid } });
};
